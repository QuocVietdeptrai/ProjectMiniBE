...
class ListOrderTest extends TestCase
{
    ...
    public function list_orders()
    {
        ...
        // Create order without student first
        $order = Order::create([
            'user_id' => $user->id,
        ...
        // Create student and assign to order
        ...
        $response = $this->authAdmin()->getJson('/api/orders/list');
    ...
    /** @test */
    public function search_order_by_student_name()
    {
        $user = User::factory()->create();
        ...
        $response = $this->authAdmin()->getJson('/api/orders/list?search=Nguyễn');
